<div class="wrap <?php echo self::$textdomain; ?>">
	<h2><?php _e( 'Custom Post Types', self::$textdomain ); ?> <a class="add-new-h2" href="/wp-admin/admin.php?page=toolset-custom-post-types-edit">Add New</a></h2>	
	<?php 
					...
					<tbody>
						<?php 
							foreach ($this->option() as $post_type => $cpt) { 
								$edit_link = '/wp-admin/admin.php?page=toolset-custom-post-types-edit&amp;post-type=' . $cpt['post_type'];
						?>
