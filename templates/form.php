<form action="" data-action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST" class="<?php echo self::$textdomain; ?>_form">		
		...
		<div class="<?php echo self::$textdomain; ?>_options_content">
			<div class="<?php echo self::$textdomain; ?>_wrapper_half first">
				...
				<div class="<?php echo self::$textdomain; ?>_cpt_option">
					<?php 			
						$checked = $cpt['enabled'] == '1' ? 'checked="checked" ' : '' ; 
						$field_id = $field_id_part . 'yes'; 
					?>	
					...
					<div class="<?php echo self::$textdomain; ?>_cpt_input_wrapper radio">					
						<label for="<?php echo $field_id; ?>">
							<input type="radio" autocomplete="off" name="<?php echo $field_name; ?>" id="<?php echo $field_id; ?>" <?php echo $checked; ?> value="1" /> <?php _e('Yes', self::$textdomain); ?>
						</label>
						<?php 
							$checked = $cpt['enabled'] == '0' ? 'checked="checked" ' : '' ; 
							$field_id = $field_id_part . 'no'; 
						?>	
						<label for="<?php echo $field_id; ?>">
							<input type="radio" autocomplete="off" name="<?php echo $field_name; ?>" id="<?php echo $field_id; ?>" <?php echo $checked; ?> value="0" /> <?php _e('No', self::$textdomain); ?>
						</label>	
				...
				<div class="<?php echo self::$textdomain; ?>_cpt_option">
					...
					<div class="<?php echo self::$textdomain; ?>_cpt_input_wrapper radio">
						<?php 			
							$checked = $cpt['public'] == '1' ? 'checked="checked" ' : '' ; 
							$field_id = $field_id_part . 'yes'; 
						?>	
						<label for="<?php echo $field_id; ?>">
							<input type="radio" autocomplete="off" name="<?php echo $field_name; ?>" id="<?php echo $field_id; ?>" <?php echo $checked; ?> value="1" /> <?php _e('Yes', self::$textdomain); ?>
						...
						<?php 
							$checked = $cpt['public'] == '0' ? 'checked="checked" ' : '' ; 
							$field_id = $field_id_part . 'no'; 
						?>	
						<label for="<?php echo $field_id; ?>">
							<input type="radio" autocomplete="off" name="<?php echo $field_name; ?>" id="<?php echo $field_id; ?>" <?php echo $checked; ?> value="0" /> <?php _e('No', self::$textdomain); ?>
				...
				<div class="<?php echo self::$textdomain; ?>_cpt_option">
					...
					<div class="<?php echo self::$textdomain; ?>_cpt_input_wrapper radio">
						<?php
							$checked = $cpt['exclude_from_search'] == '1' ? 'checked="checked" ' : '' ; 
						...
						<?php 
							$checked = $cpt['exclude_from_search'] == '0' ? 'checked="checked" ' : '' ; 
							$field_id = str_replace(array('[', ']'), '_', $field_name) . 'no'; 
						?>	
						<label for="<?php echo $field_id; ?>">
							<input type="radio" autocomplete="off" name="<?php echo $field_name; ?>" id="<?php echo $field_id; ?>" <?php echo $checked; ?> value="0" /> <?php _e('No', self::$textdomain); ?>
						</label>	
				...
				<div class="<?php echo self::$textdomain; ?>_cpt_option">
					...
					<div class="<?php echo self::$textdomain; ?>_cpt_input_wrapper radio">
						<?php
							$checked = $cpt['publicly_queryable'] == '1' ? 'checked="checked" ' : '' ; 
							$field_id = str_replace(array('[', ']'), '_', $field_name) . 'yes'; 
						?>	
						<label for="<?php echo $field_id; ?>">
							<input type="radio" autocomplete="off" name="<?php echo $field_name; ?>" id="<?php echo $field_id; ?>" <?php echo $checked; ?> value="1" /> <?php _e('Yes', self::$textdomain); ?>
						...
						<?php 
							$checked = $cpt['publicly_queryable'] == '0' ? 'checked="checked" ' : '' ; 
							$field_id = str_replace(array('[', ']'), '_', $field_name) . 'no'; 
						?>	
						<label for="<?php echo $field_id; ?>">
							<input type="radio" autocomplete="off" name="<?php echo $field_name; ?>" id="<?php echo $field_id; ?>" <?php echo $checked; ?> value="0" /> <?php _e('No', self::$textdomain); ?>
				...
				<div class="<?php echo self::$textdomain; ?>_cpt_option">
					...
					<div class="<?php echo self::$textdomain; ?>_cpt_input_wrapper radio">
						<?php
							$checked = $cpt['show_ui'] == '1' ? 'checked="checked" ' : '' ; 
							$field_id = str_replace(array('[', ']'), '_', $field_name) . 'yes'; 
						?>	
						<label for="<?php echo $field_id; ?>">
							<input type="radio" autocomplete="off" name="<?php echo $field_name; ?>" id="<?php echo $field_id; ?>" <?php echo $checked; ?> value="1" /> <?php _e('Yes', self::$textdomain); ?>
						...
						<?php 
							$checked = $cpt['show_ui'] == '0' ? 'checked="checked" ' : '' ; 
							$field_id = str_replace(array('[', ']'), '_', $field_name) . 'no'; 
						?>	
						<label for="<?php echo $field_id; ?>">
							<input type="radio" autocomplete="off" name="<?php echo $field_name; ?>" id="<?php echo $field_id; ?>" <?php echo $checked; ?> value="0" /> <?php _e('No', self::$textdomain); ?>
				...
				<div class="<?php echo self::$textdomain; ?>_cpt_option">
					...
					<div class="<?php echo self::$textdomain; ?>_cpt_input_wrapper radio">
						<?php
							$checked = $cpt['show_in_nav_menus'] == '1' ? 'checked="checked" ' : '' ; 
							$field_id = str_replace(array('[', ']'), '_', $field_name) . 'yes'; 
						?>	
						<label for="<?php echo $field_id; ?>">
							<input type="radio" autocomplete="off" name="<?php echo $field_name; ?>" id="<?php echo $field_id; ?>" <?php echo $checked; ?> value="1" /> <?php _e('Yes', self::$textdomain); ?>
						...
						<?php 
							$checked = $cpt['show_in_nav_menus'] == '0' ? 'checked="checked" ' : '' ; 
							$field_id = str_replace(array('[', ']'), '_', $field_name) . 'no'; 
						?>	
						<label for="<?php echo $field_id; ?>">
							<input type="radio" autocomplete="off" name="<?php echo $field_name; ?>" id="<?php echo $field_id; ?>" <?php echo $checked; ?> value="0" /> <?php _e('No', self::$textdomain); ?>
				...
				<div class="<?php echo self::$textdomain; ?>_cpt_option">
					...
					<div class="<?php echo self::$textdomain; ?>_cpt_input_wrapper radio">
						<?php
							$checked = $cpt['show_in_menu'] == '1' ? 'checked="checked" ' : '' ; 
							$field_id = str_replace(array('[', ']'), '_', $field_name) . 'yes'; 
						?>	
						<label for="<?php echo $field_id; ?>">
							<input type="radio" autocomplete="off" name="<?php echo $field_name; ?>" id="<?php echo $field_id; ?>" <?php echo $checked; ?> value="1" /> <?php _e('Yes', self::$textdomain); ?>
						...
						<?php 
							$checked = $cpt['show_in_menu'] == '0' ? 'checked="checked" ' : '' ; 
							$field_id = str_replace(array('[', ']'), '_', $field_name) . 'no'; 
						?>	
						<label for="<?php echo $field_id; ?>">
							<input type="radio" autocomplete="off" name="<?php echo $field_name; ?>" id="<?php echo $field_id; ?>" <?php echo $checked; ?> value="0" /> <?php _e('No', self::$textdomain); ?>
						...
						<select name="<?php echo $field_name; ?>" id="<?php echo $field_id; ?>"  value="<?php echo $cpt['show_in_sub_menu']; ?>">
							...
							<?php 
								...
								foreach ($menu as $key => $value) {											
									if ($value[0] && $value[2]) { ?>
										<option <?php echo $cpt['show_in_sub_menu'] == $value[2] ? 'selected="selected"' : '' ; ?> value="<?php echo $value[2]; ?>"><?php echo preg_replace( '/<.*?\b[^>]*>(.*?)<\/.*?>/i', "", $value[0] ); ?></option>
									<? }
								} ?>
						</select>										
				...
				<div class="<?php echo self::$textdomain; ?>_cpt_option">
					...
					<div class="<?php echo self::$textdomain; ?>_cpt_input_wrapper radio">
						<?php
							$checked = $cpt['show_in_admin_bar'] == '1' ? 'checked="checked" ' : '' ; 
							$field_id = str_replace(array('[', ']'), '_', $field_name) . 'yes'; 
						?>	
						<label for="<?php echo $field_id; ?>">
							<input type="radio" autocomplete="off" name="<?php echo $field_name; ?>" id="<?php echo $field_id; ?>" <?php echo $checked; ?> value="1" /> <?php _e('Yes', self::$textdomain); ?>
						...
						<?php 
							$checked = $cpt['show_in_admin_bar'] == '0' ? 'checked="checked" ' : '' ; 
							$field_id = str_replace(array('[', ']'), '_', $field_name) . 'no'; 
						?>	
						<label for="<?php echo $field_id; ?>">
							<input type="radio" autocomplete="off" name="<?php echo $field_name; ?>" id="<?php echo $field_id; ?>" <?php echo $checked; ?> value="0" /> <?php _e('No', self::$textdomain); ?>
				...
				<div class="<?php echo self::$textdomain; ?>_cpt_option">
					...
					<div class="<?php echo self::$textdomain; ?>_cpt_input_wrapper radio">					
						<select name="<?php echo $field_name; ?>" id="<?php echo $field_id; ?>" value="<?php echo $cpt['menu_position']; ?>">
							<option value="" <?php echo $cpt['menu_position'] == '' ? 'selected="selected"' : '' ; ?>><?php _e( 'none',  self::$textdomain ); ?></option>
							<option value="5" <?php echo $cpt['menu_position'] == '5' ? 'selected="selected"' : '' ; ?>><?php _e( 'below Posts',  self::$textdomain ); ?></option>
						    <option value="10" <?php echo $cpt['menu_position'] == '10' ? 'selected="selected"' : '' ; ?>><?php _e( 'below Media',  self::$textdomain ); ?></option>
						    <option value="15" <?php echo $cpt['menu_position'] == '15' ? 'selected="selected"' : '' ; ?>><?php _e( 'below Links',  self::$textdomain ); ?></option>
						    <option value="20" <?php echo $cpt['menu_position'] == '20' ? 'selected="selected"' : '' ; ?>><?php _e( 'below Pages',  self::$textdomain ); ?></option>
						    <option value="25" <?php echo $cpt['menu_position'] == '25' ? 'selected="selected"' : '' ; ?>><?php _e( 'below comments',  self::$textdomain ); ?></option>
						    <option value="60" <?php echo $cpt['menu_position'] == '60' ? 'selected="selected"' : '' ; ?>><?php _e( 'below first separator',  self::$textdomain ); ?></option>
						    <option value="65" <?php echo $cpt['menu_position'] == '65' ? 'selected="selected"' : '' ; ?>><?php _e( 'below Plugins',  self::$textdomain ); ?></option>
						    <option value="70" <?php echo $cpt['menu_position'] == '70' ? 'selected="selected"' : '' ; ?>><?php _e( 'below Users',  self::$textdomain ); ?></option>
						    <option value="75" <?php echo $cpt['menu_position'] == '75' ? 'selected="selected"' : '' ; ?>><?php _e( 'below Tools',  self::$textdomain ); ?></option>
						    <option value="80" <?php echo $cpt['menu_position'] == '80' ? 'selected="selected"' : '' ; ?>><?php _e( 'below Settings',  self::$textdomain ); ?></option>
						    <option value="100" <?php echo $cpt['menu_position'] == '100' ? 'selected="selected"' : '' ; ?>><?php _e( 'below second separator ',  self::$textdomain ); ?></option>
						</select>													
				...
				<div class="<?php echo self::$textdomain; ?>_cpt_option">
					...
					<div class="<?php echo self::$textdomain; ?>_cpt_input_wrapper icons">									
						<label for="<?php echo $field_id; ?>" class="default">
							<?php
								$checked = !$cpt['menu_icon'] ? 'checked="checked" ' : '' ; 
							?>
							<input type="radio" autocomplete="off" name="<?php echo $field_name; ?>" id="<?php echo $field_id; ?>" <?php echo $checked; ?> value="1" /> <?php _e( 'Default', self::$textdomain ); ?>
						</label>
						<br>
						<?php
						...
						?>	
							<label for="<?php echo $field_id; ?>" class="icon16 <?php echo 'dashicons-' . $menu_icon; ?> <?php echo $checked ? 'checked' : '' ;?>">
								<input type="radio" autocomplete="off" name="<?php echo $field_name; ?>" id="<?php echo $field_id; ?>" <?php echo $checked; ?> value="<?php echo 'dashicons-' . $menu_icon; ?>" />
							</label>
						<?php } ?>	
				...
				<div class="<?php echo self::$textdomain; ?>_cpt_option">
					...
					<div class="<?php echo self::$textdomain; ?>_cpt_input_wrapper radio">
						<?php
							$checked = $cpt['hierarchical'] == '1' ? 'checked="checked" ' : '' ; 
							$field_id = str_replace(array('[', ']'), '_', $field_name) . 'yes'; 
						?>	
						<label for="<?php echo $field_id; ?>">
							<input type="radio" autocomplete="off" name="<?php echo $field_name; ?>" id="<?php echo $field_id; ?>" <?php echo $checked; ?> value="1" /> <?php _e('Yes', self::$textdomain); ?>
						...
						<?php 
							$checked = $cpt['hierarchical'] == '0' ? 'checked="checked" ' : '' ; 
							$field_id = str_replace(array('[', ']'), '_', $field_name) . 'no'; 
						?>	
						<label for="<?php echo $field_id; ?>">
							<input type="radio" autocomplete="off" name="<?php echo $field_name; ?>" id="<?php echo $field_id; ?>" <?php echo $checked; ?> value="0" /> <?php _e('No', self::$textdomain); ?>
				...
				<div class="<?php echo self::$textdomain; ?>_cpt_option">
					...
					<div class="<?php echo self::$textdomain; ?>_cpt_input_wrapper radio">
						<?php
							$checked = $cpt['has_archive'] == '1' ? 'checked="checked" ' : '' ; 
							$field_id = str_replace(array('[', ']'), '_', $field_name) . 'yes'; 
						?>	
						<label for="<?php echo $field_id; ?>">
							<input type="radio" autocomplete="off" name="<?php echo $field_name; ?>" id="<?php echo $field_id; ?>" <?php echo $checked; ?> value="1" /> <?php _e('Yes', self::$textdomain); ?>
						...
						<?php 
							$checked = $cpt['has_archive'] == '0' ? 'checked="checked" ' : '' ; 
							$field_id = str_replace(array('[', ']'), '_', $field_name) . 'no'; 
						?>	
						<label for="<?php echo $field_id; ?>">
							<input type="radio" autocomplete="off" name="<?php echo $field_name; ?>" id="<?php echo $field_id; ?>" <?php echo $checked; ?> value="0" /> <?php _e('No', self::$textdomain); ?>
				...
				<div class="<?php echo self::$textdomain; ?>_cpt_option">
					...
					<div class="<?php echo self::$textdomain; ?>_cpt_input_wrapper radio">
						<?php
							$checked = $cpt['rewrite'] == '1' ? 'checked="checked" ' : '' ; 
							$field_id = str_replace(array('[', ']'), '_', $field_name) . 'yes'; 
						?>	
						<label for="<?php echo $field_id; ?>">
							<input type="radio" autocomplete="off" name="<?php echo $field_name; ?>" id="<?php echo $field_id; ?>" <?php echo $checked; ?> value="1" /> <?php _e('Yes', self::$textdomain); ?>
						...
						<?php 
							$checked = $cpt['rewrite'] == '0' ? 'checked="checked" ' : '' ; 
							$field_id = str_replace(array('[', ']'), '_', $field_name) . 'no'; 
						?>	
						<label for="<?php echo $field_id; ?>">
							<input type="radio" autocomplete="off" name="<?php echo $field_name; ?>" id="<?php echo $field_id; ?>" <?php echo $checked; ?> value="0" /> <?php _e('No', self::$textdomain); ?>
						...
						<?php
							...
							$checked = $cpt['rewrite_with_front'] == '1' ? 'checked="checked" ' : '' ; 
							$field_id = str_replace(array('[', ']'), '_', $field_name) . 'yes'; 
						?>	
						<label for="<?php echo $field_id; ?>">
							<input type="radio" autocomplete="off" name="<?php echo $field_name; ?>" id="<?php echo $field_id; ?>" <?php echo $checked; ?> value="1" /> <?php _e('Yes', self::$textdomain); ?>
						...
						<?php 
							$checked = $cpt['rewrite_with_front'] == '0' ? 'checked="checked" ' : '' ; 
							$field_id = str_replace(array('[', ']'), '_', $field_name) . 'no'; 
						?>	
						<label for="<?php echo $field_id; ?>">
							<input type="radio" autocomplete="off" name="<?php echo $field_name; ?>" id="<?php echo $field_id; ?>" <?php echo $checked; ?> value="0" /> <?php _e('No', self::$textdomain); ?>
						...
						<?php
							...
							$checked = $cpt['rewrite_feeds'] == '1' ? 'checked="checked" ' : '' ; 
							$field_id = str_replace(array('[', ']'), '_', $field_name) . 'yes'; 
						?>	
						<label for="<?php echo $field_id; ?>">
							<input type="radio" autocomplete="off" name="<?php echo $field_name; ?>" id="<?php echo $field_id; ?>" <?php echo $checked; ?> value="1" /> <?php _e('Yes', self::$textdomain); ?>
						...
						<?php 
							$checked = $cpt['rewrite_feeds'] == '0' ? 'checked="checked" ' : '' ; 
							$field_id = str_replace(array('[', ']'), '_', $field_name) . 'no'; 
						?>	
						<label for="<?php echo $field_id; ?>">
							<input type="radio" autocomplete="off" name="<?php echo $field_name; ?>" id="<?php echo $field_id; ?>" <?php echo $checked; ?> value="0" /> <?php _e('No', self::$textdomain); ?>
						...
						<?php
							...
							$checked = $cpt['rewrite_pages'] == '1' ? 'checked="checked" ' : '' ; 
							$field_id = str_replace(array('[', ']'), '_', $field_name) . 'yes'; 
						?>	
						<label for="<?php echo $field_id; ?>">
							<input type="radio" autocomplete="off" name="<?php echo $field_name; ?>" id="<?php echo $field_id; ?>" <?php echo $checked; ?> value="1" /> <?php _e('Yes', self::$textdomain); ?>
						...
						<?php 
							$checked = $cpt['rewrite_pages'] == '0' ? 'checked="checked" ' : '' ; 
							$field_id = str_replace(array('[', ']'), '_', $field_name) . 'no'; 
						?>	
						<label for="<?php echo $field_id; ?>">
							<input type="radio" autocomplete="off" name="<?php echo $field_name; ?>" id="<?php echo $field_id; ?>" <?php echo $checked; ?> value="0" /> <?php _e('No', self::$textdomain); ?>
				...
				<div class="<?php echo self::$textdomain; ?>_cpt_option">
					...
					<div class="<?php echo self::$textdomain; ?>_cpt_input_wrapper radio">
						<?php
							$checked = $cpt['query_var'] == '1' ? 'checked="checked" ' : '' ; 
							$field_id = str_replace(array('[', ']'), '_', $field_name) . 'yes'; 
						?>	
						<label for="<?php echo $field_id; ?>">
							<input type="radio" autocomplete="off" name="<?php echo $field_name; ?>" id="<?php echo $field_id; ?>" <?php echo $checked; ?> value="1" /> <?php _e('Yes', self::$textdomain); ?>
						...
						<?php 
							$checked = $cpt['query_var'] == '0' ? 'checked="checked" ' : '' ; 
							$field_id = str_replace(array('[', ']'), '_', $field_name) . 'no'; 
						?>	
						<label for="<?php echo $field_id; ?>">
							<input type="radio" autocomplete="off" name="<?php echo $field_name; ?>" id="<?php echo $field_id; ?>" <?php echo $checked; ?> value="0" /> <?php _e('No', self::$textdomain); ?>
				...
				<div class="<?php echo self::$textdomain; ?>_cpt_option">
					...
					<div class="<?php echo self::$textdomain; ?>_cpt_input_wrapper radio">
						<?php
							$checked = $cpt['can_export'] == '1' ? 'checked="checked" ' : '' ; 
							$field_id = str_replace(array('[', ']'), '_', $field_name) . 'yes'; 
						?>	
						<label for="<?php echo $field_id; ?>">
							<input type="radio" autocomplete="off" name="<?php echo $field_name; ?>" id="<?php echo $field_id; ?>" <?php echo $checked; ?> value="1" /> <?php _e('Yes', self::$textdomain); ?>
						...
						<?php 
							$checked = $cpt['can_export'] == '0' ? 'checked="checked" ' : '' ; 
							$field_id = str_replace(array('[', ']'), '_', $field_name) . 'no'; 
						?>	
						<label for="<?php echo $field_id; ?>">
							<input type="radio" autocomplete="off" name="<?php echo $field_name; ?>" id="<?php echo $field_id; ?>" <?php echo $checked; ?> value="0" /> <?php _e('No', self::$textdomain); ?>
				...
				<div class="<?php echo self::$textdomain; ?>_cpt_option">
					...
					<div class="<?php echo self::$textdomain; ?>_cpt_input_wrapper supports">
						<?php foreach ($supports as $support => $params) { 
								...
								$checked = $cpt['supports'][$support] == '1' ? 'checked="checked" ' : '' ; 
						?>
							<input type="hidden" name="<?php echo $field_name; ?>" value="0" />
							<label for="<?php echo $field_id; ?>">
								<input type="checkbox" autocomplete="off" name="<?php echo $field_name; ?>" id="<?php echo $field_id; ?>" <?php echo $checked; ?> value="1" /> <?php echo $params[0]; ?>
							</label>
							<?php if ( isset( $params[1] ) ) { ?>
								<div class="<?php echo self::$textdomain; ?>_note"><?php echo $params[1]; ?></div>								
							<?php } ?>
						<?php } ?>
						<div class="<?php echo self::$textdomain; ?>_note"><?php _e( 'Theme features for current custom post type', self::$textdomain ); ?></div>								
					</div>			
				</div>	
				<!-- Supports end -->
				<div class="<?php echo self::$textdomain; ?>_separator"></div>
